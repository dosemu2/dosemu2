...
static const t_unicode cp863_c1_chars[] = {
0x00c7, 0x00fc, 0x00e9, 0x00e2, 0x00c2, 0x00e0, 0x00b6, 0x00e7, /* 0x80-0x87 */
0x00ea, 0x00eb, 0x00e8, 0x00ef, 0x00ee, 0x2017, 0x00c0, 0x00a7, /* 0x88-0x8F */
0x00c9, 0x00c8, 0x00ca, 0x00f4, 0x00cb, 0x00cf, 0x00fb, 0x00f9, /* 0x90-0x97 */
0x00a4, 0x00d4, 0x00dc, 0x00a2, 0x00a3, 0x00d9, 0x00db, 0x0192, /* 0x98-0x9F */
};
struct char_set cp863_c1 = {
	1,
	CHARS(cp863_c1_chars),
	0, "", 0, 32,
};

static const t_unicode cp863_g1_chars[] = {
0x00a6, 0x00b4, 0x00f3, 0x00fa, 0x00a8, 0x00b8, 0x00b3, 0x00af, /* 0xA0-0xA7 */
0x00ce, 0x2310, 0x00ac, 0x00bd, 0x00bc, 0x00be, 0x00ab, 0x00bb, /* 0xA8-0xAF */
...
struct char_set cp863_g1 = {
	1,
	CHARS(cp863_g1_chars),
	0, "", 0, 96,
};

struct char_set cp863 = {
	.c0 = &ibm_ascii_c0,
	.g0 = &ibm_ascii_g0,
	.c1 = &cp863_c1,
	.g1 = &cp863_g1,
