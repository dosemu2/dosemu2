...
static unsigned char MyAddress[10]= {0x01,0x01,0x01,0xf0,
...
static void ipx_remove_socket(ipx_socket_t *sk)
{
	ipx_socket_t *s;
...
static void ipx_insert_socket(u_short socket, u_short PSP, int fd)
{
	ipx_socket_t *sk;
...
static ipx_socket_t *ipx_find_socket(int port)
{
	ipx_socket_t *s;
