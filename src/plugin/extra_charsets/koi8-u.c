...
static const t_unicode koi8_u_c1_chars[] = {
...
struct char_set koi8_u_c1 = {
	1,
	CHARS(koi8_u_c1_chars),
	0, "", 0, 32,
};

static const t_unicode koi8_u_g1_chars[] = {
...
0x255F, 0x2560, 0x2561, 0x0401, /* 0xB0-0xB3 */
0x0404, /* 0xB4 - CYRILLIC CAPITAL LETTER UKRAINIAN IE */
0x2563, 0x0406, 0x0407, /* 0xB5-0xB7 */
...
struct char_set koi8_u_g1 = {
	1,
	CHARS(koi8_u_g1_chars),
	0, "", 1, 96,
};

struct char_set koi8_u = {
	.c0 = &ascii_c0,
	.g0 = &ascii_g0,
	.c1 = &koi8_u_c1,
	.g1 = &koi8_u_g1,
