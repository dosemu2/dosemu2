...
int	_dpmi_get_segment_base_address(sigcontext_t *scp, int is_32, int _selector, unsigned long *_addr);			/* DPMI 0.9 AX=0006 */
int	_dpmi_set_segment_base_address(sigcontext_t *scp, int is_32, int _selector, unsigned long _address);			/* DPMI 0.9 AX=0007 */
unsigned long _dpmi_get_segment_limit(sigcontext_t *scp, int is_32, int _selector);						/* LSL instruction  */
int	_dpmi_set_segment_limit(sigcontext_t *scp, int is_32, int _selector, unsigned long _limit);				/* DPMI 0.9 AX=0008 */
...
int	_dpmi_free_memory(sigcontext_t *scp, int is_32, unsigned long _handle);						/* DPMI 0.9 AX=0502 */
...
int	_dpmi_map_device_in_memory_block(sigcontext_t *scp, int is_32, __dpmi_meminfo *_info, unsigned long _physaddr);	/* DPMI 1.0 AX=0508 */
int	_dpmi_map_conventional_memory_in_memory_block(sigcontext_t *scp, int is_32, __dpmi_meminfo *_info, unsigned long _physaddr); /* DPMI 1.0 AX=0509 */
...
int	_dpmi_get_page_size(sigcontext_t *scp, int is_32, unsigned long *_size);						/* DPMI 0.9 AX=0604 */
...
int	_dpmi_clear_debug_watchpoint(sigcontext_t *scp, int is_32, unsigned long _handle);					/* DPMI 0.9 AX=0b01 */
int	_dpmi_get_state_of_debug_watchpoint(sigcontext_t *scp, int is_32, unsigned long _handle, int *_status);		/* DPMI 0.9 AX=0b02 */
int	_dpmi_reset_debug_watchpoint(sigcontext_t *scp, int is_32, unsigned long _handle);					/* DPMI 0.9 AX=0b03 */
...
int	_dpmi_free_shared_memory(sigcontext_t *scp, int is_32, unsigned long _handle);					/* DPMI 1.0 AX=0d01 */
int	_dpmi_serialize_on_shared_memory(sigcontext_t *scp, int is_32, unsigned long _handle, int _flags);			/* DPMI 1.0 AX=0d02 */
int	_dpmi_free_serialization_on_shared_memory(sigcontext_t *scp, int is_32, unsigned long _handle, int _flags);		/* DPMI 1.0 AX=0d03 */
