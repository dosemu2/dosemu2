 ...
 */
#define SLANG_VERSION 10408
#define SLANG_VERSION_STRING "1.4.8"
...
typedef int SLarray_Contract_Fun_Type (VOID_STAR, unsigned int, unsigned int, VOID_STAR);
typedef struct
{
...
extern int SLarray_contract_array (SLarray_Contract_Type *);
