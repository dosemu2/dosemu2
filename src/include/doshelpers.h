...
#define DOS_HELPER_TEST_MODE        0x14
...
#define DOS_SUBHELPER_SERIAL_COMREDIR_INIT 3
...
#define DOS_HELPER_TCP_HELPER       0x35
#define DOS_SUBHELPER_TCP_CONFIG    0
#define DOS_SUBHELPER_TCP_ENABLE    1
#define DOS_SUBHELPER_TCP_SETIF     2
#define DOS_SUBHELPER_TCP_GETGW     3
#define DOS_SUBHELPER_TCP_SETGW     4

#define DOS_HELPER_IPX_HELPER       0x36
#define DOS_SUBHELPER_IPX_CONNECT   0
...
#define DOS_HELPER_GET_UNIX_ENV     0x52  /* OLD, removed functionality */
