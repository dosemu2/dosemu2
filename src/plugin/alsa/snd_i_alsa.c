...
/* no plugin interface for now - TODO. Use ctors */
CONSTRUCTOR(static void _alsain_init(void))
{
    alsain_init();
    alsain_open();
}

DESTRUCTOR(static void _alsain_done(void))
{
    alsain_close();
}
