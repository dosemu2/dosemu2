...
%token L_EMS L_VCPI L_JEMM UMB_A0 UMB_B0 UMB_B8 UMB_F0 HMA DOS_UP
...
%token SOUND_DRIVER MIDI_DRIVER FLUID_SFONT FLUID_SFONT_MT32 FLUID_VOLUME OMT_SFZ_PATH
...
line:		CHARSET '{' charset_flags '}' {}
		...
		*/
		...
		| L_VCPI bool		{ config.vcpi = ($2!=0); }
		| L_JEMM bool		{ config.jemm = ($2!=0); }
		| UMB_A0 bool
		    {
		    config.umb_a0 = $2;
