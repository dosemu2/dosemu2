...
int DPMI_SetPageAttributes(dpmi_pm_block_root *root, unsigned handle, int offs, u_short attrs[], int count);
int DPMI_GetPageAttributes(dpmi_pm_block_root *root, unsigned handle, int offs, u_short attrs[], int count);
