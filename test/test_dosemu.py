...
from func_memory_dpmi_hwint_balance import memory_dpmi_hwint_balance
...
class OurTestCase(BaseTestCase):
    ...
    @mark(['memtest', 'dpmitest'])
    def test_memory_dpmi_hwint_balance(self):
        """Memory DPMI return from a hardware interrupt not delivered"""
        memory_dpmi_hwint_balance(self)
