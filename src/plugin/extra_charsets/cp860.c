...
static const t_unicode cp860_c1_chars[] = {
0x00c7, 0x00fc, 0x00e9, 0x00e2, 0x00e3, 0x00e0, 0x00c1, 0x00e7, /* 0x80-0x87 */
0x00ea, 0x00ca, 0x00e8, 0x00cd, 0x00d4, 0x00ec, 0x00c3, 0x00c2, /* 0x88-0x8F */
0x00c9, 0x00c0, 0x00c8, 0x00f4, 0x00f5, 0x00f2, 0x00da, 0x00f9, /* 0x90-0x97 */
0x00cc, 0x00d5, 0x00dc, 0x00a2, 0x00a3, 0x00d9, 0x20a7, 0x00d3, /* 0x98-0x9F */
};
struct char_set cp860_c1 = {
	1,
	CHARS(cp860_c1_chars),
	0, "", 0, 32,
};

static const t_unicode cp860_g1_chars[] = {
0x00e1, 0x00ed, 0x00f3, 0x00fa, 0x00f1, 0x00d1, 0x00aa, 0x00ba, /* 0xA0-0xA7 */
0x00bf, 0x00d2, 0x00ac, 0x00bd, 0x00bc, 0x00a1, 0x00ab, 0x00bb, /* 0xA8-0xAF */
...
struct char_set cp860_g1 = {
	1,
	CHARS(cp860_g1_chars),
	0, "", 0, 96,
};

struct char_set cp860 = {
	.c0 = &ibm_ascii_c0,
	.g0 = &ibm_ascii_g0,
	.c1 = &cp860_c1,
	.g1 = &cp860_g1,
