 ...
 * come up: it remembers the characteristics table of the module that
 * registers with it. The test program tndisapp.com then picks that
 * table up through a private request opcode and binds itself to the
 * MAC as a protocol would.
 *
 * Author: Stas Sergeev
 */
